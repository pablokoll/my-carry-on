...
def compact_if_needed(session_id: int, user_id: int, provider) -> list[ChatMessage]:
...
def set_title_if_needed(session: ChatSession, user_message: str, reply: str, is_first: bool, provider) -> str | None:
